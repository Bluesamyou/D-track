...
const VehicleForm = (props) => (
    ...
    <Col>
        ...
        <Col xs={{ span: 12 }}>
            <Button xs={6} id="searchRego" variant="success" type="" onClick={props.searchRego} >
                Search
    </Button>
            <Button xs={6} id="manualEntry" variant="success" type="" onClick={props.manualEntry}>
                Manual Entry
    </Button>
        ...
        {props.loading ?
            ...
            : props.displayCard ?
                ...
                : props.manual ?
                    ...
                    :
                    <Col id="container">
                        <h5>To begin enter the registration number and state above or manually enter the vehicle details</h5>
                    </Col>
